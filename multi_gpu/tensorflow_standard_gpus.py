"""This is the scripts to implement the multiple gpus using standard tensorflow methdos
"""
...
def average_gradients(tower_grads):
    """Average gradient over different gpus
    
    Arguments:
        tower_grads {[list]} -- [list of (gradient, var)]
    
    Returns:
        [list] -- [list of (ave_gradient, var)]
    """
